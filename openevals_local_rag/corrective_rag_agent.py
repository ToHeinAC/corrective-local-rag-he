...
helpfulness_evaluator = create_async_llm_as_judge(
    ...
    + f'\nReturn "true" if the answer is helpful, "false" otherwise.\n\nThe current date is {current_date}.',
...
Please try regenerating an answer based on context or fetching more information.
...
If you choose to fetch more information, you must rephrase your search query to be different from the ones above.
If you decide you already have enough information in your context, simply refocus your answer and respond directly.
""",
                }
            ]
        }
